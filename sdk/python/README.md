...
This is an unsupported example, not a packaged SDK: no pyproject, package
structure, typing, tests, or release process, and it covers only userinfo,
...
- `verify_webhook_signature` checks HMAC and timestamp freshness (5 minutes).
