...
create unique index billing_transfers_reference_idx
...
create index billing_entries_account_idx on billing_entries(account_id, id);
create index billing_entries_transfer_idx on billing_entries(transfer_id);
