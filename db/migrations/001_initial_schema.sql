...
create index if not exists external_app_oauth_secrets_app_idx on external_app_oauth_secrets(external_app_id);
...
create index if not exists activation_requests_app_idx on activation_requests(external_app_id);
create index if not exists activation_requests_status_idx on activation_requests(status);
create index if not exists activation_requests_expires_at_idx on activation_requests(expires_at);
...
create index if not exists subscriptions_user_product_idx on subscriptions(user_id, product);
...
create index if not exists registration_requests_expires_at_idx on registration_requests(expires_at);
...
create index if not exists bans_kind_value_idx on bans(kind, value_hash);
...
create index if not exists oauth_pushed_requests_expires_at_idx on oauth_pushed_requests(expires_at);
